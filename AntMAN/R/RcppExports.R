...
IAM_mcmc_fit <- function(y, mix_kernel_hyperparams, initial_clustering, mix_components_prior, mix_weight_prior, mcmc_parameters) {
    .Call('_AntMAN_IAM_mcmc_fit', PACKAGE = 'AntMAN', y, mix_kernel_hyperparams, initial_clustering, mix_components_prior, mix_weight_prior, mcmc_parameters)
}
